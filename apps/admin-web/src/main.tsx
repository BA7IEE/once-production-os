...
function MemberForm({ member: existing, onClose, onSaved }: {
    ...
    const [extras, setExtras] = useState<Array<'sensitive.read' | 'sensitive.write' | 'data.export' | 'data.delete'>>(existing?.extraPermissions ?? []);
    const a = useAction();
