...
function MemberForm({ member: existing, onClose, onSaved }: {
    ...
    const [extras, setExtras] = useState<Array<'sensitive.read' | 'sensitive.write' | 'data.export'>>(existing?.extraPermissions ?? []);
    const a = useAction();
