...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
    ADMIN: ['assets.read', 'assets.upload', 'records.read', 'records.write', 'sources.read', 'sources.write', 'sources.review', 'members.manage', 'catalog.manage', 'audit.read', 'data.export'],
